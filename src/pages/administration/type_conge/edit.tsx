...
export const EditTypeConger: FunctionComponent<AddModalProps> = ({ isOpen, onClose ,updateDefaultData , id}) => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        axios.put(`http://localhost:3001/api/type/${id}`, {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            setItemDesignation(response?.data.designation);
        }
        fetchData();
    }, []);
    return (
