...
export const RefusedRequest: FunctionComponent<AddModalProps> = ({ id,isOpen, onClose,updateDefaultData,type_conge }) => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
		...
		if (result.isConfirmed) {
			...
			try {
                if(type_conge !== null){
                    axios.put(`http://localhost:3001/api/conge/refuse/${id}`,{
                        remarque: remarque
                    }).then(()=>{
                        Toast.fire({
                            icon: 'success',
                    ...
                    axios.put(`http://localhost:3001/api/permission/refuse/${id}`,{
                        remarque: remarque
                    }).then(()=>{
                        Toast.fire({
                            icon: 'success',
                ...
                <ModalContent maxW="400px"  backgroundColor= "white" p={"24px"}>
                    ...
                    <>
                        <Heading textAlign="center"
                            ...
                            fontWeight="bold" 
                            mb="4">
                            <Text>Ajouter vos remaque avant de refuser</Text>
                        </Heading>
